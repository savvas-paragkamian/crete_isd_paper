...
Global soil microbiome studies \cite{Delgado-Baquerizo2018} and \cite{Bahram2018} and the biogeography \cite{Martiny2006} \cite{Guerra2020}, \cite{Labouyrie2023} yet there are significant blind spots \cite{Guerra2020}. The most resolute study is \cite{Karimi2020} which exemplified the 
...
Genome Standards Consortium \cite{Field2011} "put standards into action" and the 
18th workshop. 
The choice of an island
Islands are nature's labs \cite{Whittaker2017} and in soil microbes \cite{Li2020} and fungi \cite{Delavaux2021}
Ultimately islands can set the ground to represent ecosystems with data and complex interactions \cite{Davies2016}.
A large scale study in the confined space of the island of Crete, a miniature continent.


The island of Crete, Greece has been studied since the classical times for its' fauna \cite{Sidiropoulos_Polymeni_Legakis_2017,Anastasiou2018Tenebrionid}, flora \cite{Krimbas_2005} and ecosystems \cite{Grove1993}.
...
Crete is a continental island, fifth largest island of the mediterranean, a mediterranean biodiversity hotspot, model for desertification, climate change \cite{Kougioumoutzis2020} and habitat loss \cite{ISPIKOUDIS1993259},
elevation gradient \cite{trigas2013, FAZAN2017}, grasing impacts on ecosystems \cite{JouffroyBapicot2016} and evolutionary model \cite{POULAKAKIS2002}.
Yet the terrestrial microbial diversity has been unexplored.

Has been sampled from major worldwide projects of microbiome studies \cite{Vasar2022, Labouyrie2023, Bahram2018, Orgiazzi2018}. Soil fungi \cite{Mikryukov2023, Davison2021, Tedersoo2021} and other soil eukaryotes \cite{Aslani2022}


\cite{Vogiatzakis2008_crete}
\cite{Vogiatzakis2016}

\cite{Sfenthourakis2017}
\cite{Vogiatzakis2008_med}

Integration of prior knowledge and 
Genome Standards Consortium \cite{Field2011}, FAIR data \cite{Wilkinson2016}, unrestricted \cite{Amann2019},
rich metadata and platforms of hosting open data like European Soil Data Centre \cite{Panagos2022}

Interactomes as a driver of community composition. Microbial interactions challenges \cite{Faust2021} cohesion? 
