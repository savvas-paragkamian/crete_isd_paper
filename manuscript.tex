...
\abstract{
    ...
    The integration of the spatial data presented here enabled warning signals
...
Crete geological bedrock formations were downloaded from IGME.
...
in Julia language version 1.9.3 \cite{Julia-2017}. To use FlashWeave we reduced 
the abandunce table of the ASVs to keep the ones at the genus or species level.
In addition, we filtered these taxa that appeared in ### samples and had more than 
#### mean relative abundance. The subsequent network analyses were carried out
...
The environment we worked had Python 3.11.4 and R version 4.3.2 \cite{rcoreteam}. 
